...
const Detail = ( props ) => {
  return (
    <View style={styles.container}>
      ...
      The Maxx Scooter gets an ACG starter for a silent start, an engine kill switch, an integrated pass switch, 
      and an optional LED headlight.
      </Text>
